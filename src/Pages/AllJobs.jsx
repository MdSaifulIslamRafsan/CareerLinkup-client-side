  ...
  return (
    <div className='px-6 py-10 mx-auto min-h-[calc(100vh-306px)] flex flex-col justify-between'>
      ...
      <div className='flex justify-center mt-12'>
        <button onClick={() => handlePaginationBtn(currentPage - 1)} className='btn btn-outline btn-primary' disabled={currentPage === 1}>
        ...
        {pages.map(btnNum => (
          ...
          onClick={()=> handlePaginationBtn(btnNum)}
            ...
            className={`${currentPage ===  btnNum? "bg-primary text-white" : ""} hidden px-4 py-2 mx-1 transition-colors duration-300 transform  rounded-md sm:inline hover:bg-primary  hover:text-white`}
          >
            {btnNum}
          </button>
        ))}

        <button  onClick={() => handlePaginationBtn(currentPage + 1)} disabled={currentPage === Math.ceil(count / itemsPerPage)} className='btn btn-outline btn-primary'>
          <div className='flex items-center -mx-1'>
