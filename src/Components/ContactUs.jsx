    ...
    emailjs
      ...
      .then(
        () => {
            ...
            Swal.fire({
                title: "Good job!",
                text: "You've been successfully message send",
                icon: "success",
              });
        },
        (error) => {
      ...
      >
         <div className="flex flex-wrap">
            <form ref={form} onSubmit={sendEmail} className="mb-12 w-full shrink-0 grow-0 basis-auto md:px-3 lg:mb-0 lg:w-5/12 lg:px-6">
                ...
                <button type="submit" value="Send" className="mb-6 inline-block w-full rounded bg-blue-500 px-6 py-2.5 font-medium uppercase leading-normal text-white hover:shadow-md hover:bg-blue-800">
                    Send
                </button>
            </form>
