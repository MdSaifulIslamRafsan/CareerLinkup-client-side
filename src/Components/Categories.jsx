    ...
    <section>
      ...
      >
        <div className="text-center my-20 md:w-2/3 mx-auto space-y-4">
          ...
          <p>
            The Job By Category section features tabs for various job types .
            Each tab provides a brief description of the specific job role
            within that category, streamlining the job search process.
          </p>
        </div>
      </motion.div>
